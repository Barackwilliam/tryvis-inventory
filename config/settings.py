...
COMPANY_EMAIL = os.environ.get("COMPANY_EMAIL", "info@tryvis.co.tz")
# Printed on every invoice and quotation. Not secret — customers need them to pay.
COMPANY_ACCOUNT_NAME = os.environ.get("COMPANY_ACCOUNT_NAME", "Tryvis Investments Limited")
COMPANY_BANK_NAME = os.environ.get("COMPANY_BANK_NAME", "CRDB")
COMPANY_BANK_BRANCH = os.environ.get("COMPANY_BANK_BRANCH", "Lumumba")
COMPANY_BANK_ACCOUNT = os.environ.get("COMPANY_BANK_ACCOUNT", "0150923410000")
COMPANY_BANK_SWIFT = os.environ.get("COMPANY_BANK_SWIFT", "CORUTZTZXXX")
